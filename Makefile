...
ifeq ($(OS),Linux)
	...
	g++ -I/usr/local/include/opencv -I/usr/local/include/restbed -O0 -g3 -Wall -c -fmessage-length=0 -std=c++11 -MMD -MP -MF"./dist/websocket_handler.d" -MT"./dist/websocket_handler.o" -o "./dist/websocket_handler.o" "./src/websocket_handler.cpp"
