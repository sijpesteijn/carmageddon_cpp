...
carmageddon: ./dist/gpio.o ./dist/pwm.o ./dist/rest.o ./dist/car_resource.o ./dist/camera_resource.o ./dist/websocket_handler.o ./dist/camera.o ./dist/car.o ./dist/steer.o ./dist/engine.o ./dist/main.o
...
./dist/rest.o: ./src/rest/rest.cpp ./src/rest/rest.h ./src/rest/camera_resource.h ./src/rest/car_resource.h ./src/rest/websocket_handler.h
	$(CC) $(LIBS) $(CFLAGS) -o./dist/rest.o ./src/rest/rest.cpp
	
./dist/car_resource.o: ./src/rest/car_resource.cpp ./src/rest/rest.h ./src/rest/car_resource.h ./src/rest/websocket_handler.h ./src/domain/car.h
	$(CC) $(LIBS) $(CFLAGS) -o./dist/car_resource.o ./src/rest/car_resource.cpp
	
./dist/camera_resource.o: ./src/rest/camera_resource.cpp ./src/rest/rest.h ./src/rest/camera_resource.h ./src/rest/websocket_handler.h ./src/domain/camera.h
	$(CC) $(LIBS) $(CFLAGS) -o./dist/camera_resource.o ./src/rest/camera_resource.cpp
  
./dist/websocket_handler.o: ./src/rest/websocket_handler.cpp ./src/rest/websocket_handler.h
	$(CC) $(LIBS) $(CFLAGS) -o./dist/websocket_handler.o ./src/rest/websocket_handler.cpp
...
./dist/main.o: ./main.cpp
	$(CC) $(LIBS) $(CFLAGS) -o./dist/main.o ./main.cpp
